...
async function test() {
    try {
        const period1 = new Date(Date.now() - 720 * 24 * 60 * 60 * 1000); // 720 days ago
        const period2 = new Date();
        
        console.log("Fetching 90m data for ES=F...");
        const esResult = await yahooFinance.chart('ES=F', { period1, period2, interval: '90m' });
